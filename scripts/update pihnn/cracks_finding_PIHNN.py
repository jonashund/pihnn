...
if (__name__=='__main__'):
    ...
    for i in range(n_runs):
        ...
        boundary = geom.boundary([line1, line2, line3, line4, crack],
                                 np_train, np_test, enrichment='rice')
...
########################### optimizer : adam ###################################
        ...
        loss_train, loss_test, ListeZ1 , ListeZ2= utils.train_finding_adam(
            ...
            boundary, model, n_epochs, learn_rate, scheduler_apply, scheduler_gamma=0.5)
